...
In this tutorial, we will build a music genre classification system using the GTZAN dataset to identify the genre of a given audio track.
...
[![Wikipedia article: Sampling (signal_processing)](Screenshot 2024-06-19 at 4.36.31 PM.png){fig-align="center"}](https://en.wikipedia.org/wiki/Sampling_(signal_processing))
...
![](Screenshot 2024-06-19 at 10.23.29 PM.png){fig-align="center"}
...
![](Screenshot 2024-06-20 at 2.47.50 PM.png){fig-align="center"}
...
![](Screenshot 2024-06-20 at 6.17.17 PM.png)

## Conclusion

In this tutorial, we provided a step-by-step guide for fine-tuning the DistilHuBERT model for a music classification task. It has also been a learning journey for me, and I drew much inspiration from the work of the Hugging Face [audio course](https://huggingface.co/learn/audio-course/en/chapter4/introduction) as I began this project. Every step shown here can be applied to any audio classification task. If you're interested in exploring other datasets or models, I recommend checking out other [examples](https://github.com/huggingface/transformers/tree/main/examples/pytorch/audio-classification) in the 🤗 Transformers repository.
